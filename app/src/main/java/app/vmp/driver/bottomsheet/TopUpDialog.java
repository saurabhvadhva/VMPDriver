...
//                                }
                        ...
                        if(msg.obj.toString().equalsIgnoreCase("can't find card !")){
...

                            {
                                ...
                                double newupdatedamount = Double.parseDouble(etAmount.getText().toString()) + Double.parseDouble(tvBalance.getText().toString());
...
//
//    ArrayList<String> SqliteNFCCardId;
//    ArrayList<String> SqliteAmount;
//    ArrayList<String> SqliteUserid;
    ...
    public TopUpDialog(Context context,boolean isShg){
        mContext = context;
        this.isShg = isShg;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.dialog_topup_card, container,false);
